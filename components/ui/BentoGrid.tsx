    ...
    >
      <div className={`${id === 6} && "flex justify-center h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/bento:translate-x-2 transition duration-200 relative md:h-full m-h-40 flex flex-col px-5 p-5 lg:p-10"
          )}
        >
          <div className="font-sans font-exttalight text-[#c1c2d3] text-sm md:text-xs lg:text-base z-10">
            {description}
          </div>
